...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="bg-alt-black h-full">
    ...
    @if (request()->is('/'))
    <img class="fixed lg:absolute top-0 bottom-0 left-0 right-0 w-full h-screen object-top lg:h-636 xl:h-681.5 fade-bottom -z-10" src="/images/theme/qhmg_dark_bg.png" alt="">
    @endif
